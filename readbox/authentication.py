...
class OAuth20Authentication(Authentication):
    ...
    '''
    def __init__(self, realm='API', allow_django_superuser=False):
        self.realm = realm
        self.allow_django_superuser = allow_django_superuser
    ...
    def is_authenticated(self, request, **kwargs):
        ...
        try:
            if(self.allow_django_superuser and request.user.is_authenticated()
