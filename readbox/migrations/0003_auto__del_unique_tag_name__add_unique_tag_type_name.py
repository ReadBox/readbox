...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'readbox_tag', ['name'])

        # Adding unique constraint on 'Tag', fields ['type', 'name']
        db.create_unique('readbox_tag', ['type_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Tag', fields ['type', 'name']
        db.delete_unique('readbox_tag', ['type_id', 'name'])

        # Adding unique constraint on 'Tag', fields ['name']
        db.create_unique(u'readbox_tag', ['name'])
    ...
    models = {
        ...
        u'readbox.tag': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['readbox.TagType']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'readbox.tagtype': {
