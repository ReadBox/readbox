...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReadboxUser'
        db.create_table(u'auth_readboxuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'auth', ['ReadboxUser'])

        # Adding M2M table for field groups on 'ReadboxUser'
        m2m_table_name = db.shorten_name(u'auth_readboxuser_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('readboxuser', models.ForeignKey(orm[u'auth.readboxuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['readboxuser_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'ReadboxUser'
        m2m_table_name = db.shorten_name(u'auth_readboxuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('readboxuser', models.ForeignKey(orm[u'auth.readboxuser'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['readboxuser_id', 'permission_id'])

        # Adding model 'Token'
        db.create_table(u'auth_token', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'auth', ['Token'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ReadboxUser'
        db.delete_table(u'auth_readboxuser')

        # Removing M2M table for field groups on 'ReadboxUser'
        db.delete_table(db.shorten_name(u'auth_readboxuser_groups'))

        # Removing M2M table for field user_permissions on 'ReadboxUser'
        db.delete_table(db.shorten_name(u'auth_readboxuser_user_permissions'))

        # Deleting model 'Token'
        db.delete_table(u'auth_token')
